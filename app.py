...
# =========================
# Expand dictionary into lists
# =========================
questions = []
responses = []
for keys, resp in qa_mapping.items():
    for q in keys:
        questions.append(q.lower().strip())
        responses.append(resp)

# =========================
# Load embedding model once (startup)
# =========================
model_embed = SentenceTransformer("all-MiniLM-L6-v2")
question_vectors = model_embed.encode(questions, normalize_embeddings=True)
